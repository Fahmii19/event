...
class MataKuliah extends CI_Controller
{
    ...
    public function index()
    {
        ...
        $this->load->view('matakuliah/mahasiswa', $data);
    ...
    public function create_mahasiswa()
    {
        ...
        $this->load->view('partial/header');
        $this->load->view('partial/sidebar');
        $this->load->view('matakuliah/create_mahasiswa', $data);
        $this->load->view('partial/footer');
    }
    ...
    public function view_mahasiswa()
    {
        ...
        $this->load->view('partial/header');
        $this->load->view('partial/sidebar');
        $this->load->view('matakuliah/view_mahasiswa', $data);
        $this->load->view('partial/footer');
    }
    ...
    public function edit_mahasiswa($id)
    {
        ...
        $this->load->view('partial/header');
        $this->load->view('partial/sidebar');
        $this->load->view('matakuliah/edit_mahasiswa', $data);
        $this->load->view('partial/footer');
    }
